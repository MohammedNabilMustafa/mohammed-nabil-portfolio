  ...
  approach: [
    {
      ...
      description:
        'Every engagement starts with operational discovery — mapping how the company actually runs before writing a single line of code.',
    },
    {
      title: 'Design the System Architecture',
      description:
        'Modules, data flows, user roles, and integrations planned as a cohesive platform — not a collection of features.',
    },
    {
      title: 'Build for Daily Operations',
      description:
        'Software shaped for the people who use it every day — factory staff, sales teams, finance, and executives.',
    },
    {
      title: 'Iterate and Scale',
      description:
        'Platforms built to evolve — new modules, automations, and capabilities added as the business grows.',
    },
  ],
  closing:
    'I do not sell React websites. I build enterprise software that transforms how businesses operate.',
};
